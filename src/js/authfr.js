...
default {
  error: {
    ...
    login: {
      ...
      "lock.mfa_registration_required": "Une authentification multifactorielle est requise mais votre appareil n'est pas inscrit. Veuillez inscrire cet appareil avant de continuer.",
  ...
  mfaLoginTitle: "Vérification multifactorielle",
  mfaLoginInstructions: "Veuillez inscrire le code de vérification généré par votre application mobile.",
  mfaSubmitLabel: "Soumettre",
